...
export function SearchBar({ value, onChange, onSettingsClick }: SearchBarProps) {
  ...
  return (
    <div className="flex items-center gap-3 border-b border-[var(--color-border)] px-4 py-3">
      ...
      <button
        ...
        aria-label="Settings"
        className="shrink-0 rounded-md p-1 text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-surface)] hover:text-[var(--color-text)]"
      >
